...
INSERT INTO `dondathang` (`dh_ma`, `dh_ngaylap`, `dh_ngaygiao`, `dh_noigiao`, `dh_trangthaithanhtoan`, `httt_ma`, `kh_tendangnhap`) VALUES
	...
	(2, '2013-02-21 16:46:33', '2013-02-07 00:00:00', 'ĂƒÂ¡dsadsad', 0, 1, 'vdduy'),
...
INSERT INTO `hinhthucthanhtoan` (`httt_ma`, `httt_ten`) VALUES
	(1, 'TiĂ¡Â»Ân mĂ¡ÂºÂ·t'),
	(2, 'ChuyĂ¡Â»Æ’n khoĂ¡ÂºÂ£n'),
	(3, 'Paypal');
...
INSERT INTO `khachhang` (`kh_tendangnhap`, `kh_matkhau`, `kh_ten`, `kh_gioitinh`, `kh_diachi`, `kh_dienthoai`, `kh_email`, `kh_ngaysinh`, `kh_thangsinh`, `kh_namsinh`, `kh_cmnd`, `kh_makichhoat`, `kh_trangthai`, `kh_quantri`) VALUES
	('admin', '123', 'Quáº£n trá»‹', 1, 'Sá»‘ 01 - LĂ½ Tá»± Trá»ng - Cáº§n ThÆ¡', '0912.123.567', 'admin@salomon.vn', 2, 2, 1985, NULL, NULL, 1, 1),
	('dinhduyvo', 'fcea920f7412b5da7be0cf42b8c93759', 'Vo Dinh Duy', 0, 'Can Tho', '07103.273.34433', 'vdduy@ctu.edu.vn', 2, 2, 1985, '', '', 1, 0),
	('nhdung', 'e10adc3949ba59abbe56e057f20f883e', 'NguyĂ¡Â»â€¦n HĂƒÂ¹ng DĂ…Â©ng', 0, 'CĂ¡ÂºÂ§n ThĂ†Â¡', '0903100550', 'hungdung@ctu.edu.vn', 18, 11, 1986, '', 'dfdae6bda1be436b13e8bc4240879355', 0, 1),
	('nta', '|JÂ	Ă7bÂ¯aĂ¥â€¢ â€=Ă‚dâ€Ă¸â€', 'Nguyen Thi A', 1, 'CĂ¡ÂºÂ§n ThĂ†Â¡', '0903100550', 'nta@gmail.com', 17, 5, 1987, '', '', 0, 0),
	...
	('vdduy', 'fcea920f7412b5da7be0cf42b8c93759', 'Vo Dinh Duy', 0, 'Can Tho', '0975107705', 'vdduy@ctu.edu.vn', 2, 2, 1985, '', 'Ă¢â‚¬Âzcnl82qbuj', 1, 0);
...
INSERT INTO `loaisanpham` (`lsp_ma`, `lsp_ten`, `lsp_mota`) VALUES
	(1, 'MĂƒÂ¡y tĂƒÂ­nh bĂ¡ÂºÂ£ng', NULL),
	(2, 'MĂƒÂ¡y tĂƒÂ­nh xĂƒÂ¡ch tay', NULL),
	(3, 'Äiá»‡n thoáº¡i', NULL),
	(4, 'Linh phá»¥ kiá»‡n', NULL),
	(8, 'asada sdsad', NULL);
...
INSERT INTO `sanpham` (`sp_ma`, `sp_ten`, `sp_gia`, `sp_giacu`, `sp_mota_ngan`, `sp_mota_chitiet`, `sp_ngaycapnhat`, `sp_soluong`, `lsp_ma`, `nsx_ma`, `km_ma`) VALUES
	(1, 'Samsung Galaxy S3', 12000000.00, 12600000.00, 'Sáº£n pháº©m cá»§a Samsung nÄƒm 2013', 'Cáº¥u hĂ¬nh: CPU Dual Core â€“ Ram 1 GB', '2012-12-22 11:20:30', 17, 3, 2, NULL),
	(2, 'Apple Ipad 4 Wifi 16GB', 11800000.00, 12000000.00, 'CPU  Dual-core Cortex-A9 tá»‘c Ä‘á»™ 1GHz', 'MĂ n hĂ¬nh 9.7 inch, cáº£m á»©ng Ä‘iá»‡n dung Ä‘a Ä‘iá»ƒm', '2013-01-12 10:04:45', 100, 1, 1, NULL),
	(3, 'Apple iPhone 5 16GB', 14890000.00, NULL, 'CPU: Dual-core 1 GHz', 'Chi tiáº¿t iPhone 5', '2013-01-16 17:13:45', 0, 3, 1, NULL),
	(4, 'Apple iPhone 5 16GB White', 14990000.00, NULL, 'CPU: Dual-core 1 GHz - MĂ u tráº¯ng', 'Chi tiáº¿t iPhone 5', '2013-01-16 17:14:55', 10, 3, 1, NULL),
	(5, 'Samsung Galaxy Tab 10.1 3G 16G', 10990000.00, 12000000.00, 'MĂ n hĂ¬nh 10.1 inch cáº£m á»©ng Ä‘a Ä‘iá»ƒm', 'Vi xá»­ lĂ½ Dual-core 1 Cortex-A9 tá»‘c Ä‘á»™ 1GHz', '2013-01-17 14:18:03', 6, 1, 2, NULL),
	(6, 'Nokia Asha 311', 2699000.00, 3000000.00, 'Äiá»‡n thoáº¡i di Ä‘á»™ng Nokia Asha 311', 'MĂ n hĂ¬nh QVGA, 3.0 inches', '2013-01-17 14:19:10', 25, 3, 3, NULL),
	(7, 'Samsung Galaxy Tab 2 7.0', 7500000.00, 7950000.00, 'MĂƒÂ¡y tĂƒÂ­nh bĂ¡ÂºÂ£ng Samsung Galaxy Tab 2 7.0 ', 'MĂ¯Â¿Â½n hĂ¯Â¿Â½nh 7 inch C?m ?ng ?i?n dung,?a ?i?m', '2020-01-28 10:42:08', 13, 1, 2, NULL),
	(8, 'adasd', 5000000.00, 5000000.00, 'ĂƒÂ¡dsad', 'sadassad', '2013-01-28 10:37:52', 12, 1, 1, NULL);
